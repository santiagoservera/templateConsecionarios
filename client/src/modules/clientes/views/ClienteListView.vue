  ...
  <div class="p-6 space-y-5">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-0.5">{{ meta.total }} cliente{{ meta.total !== 1 ? 's' : '' }} en total</p>
      </div>
      ...
      <template #cell-telefono="{ value }">
        <div v-if="value" class="flex items-center gap-1.5">
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            class="text-emerald-500 hover:text-emerald-400 transition-colors shrink-0"
